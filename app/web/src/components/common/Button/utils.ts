...
export const getButtonStyles = (type: ButtonType): ButtonStyles => {
  ...
  switch (type) {
    ...
    case ButtonType.PRIMARY_FULL:
      ...
      styles.text = "text-background-600 font-bold font-size-[18px]";
      break;
    ...
    case ButtonType.BASE_FULL:
      styles.button +=
        "bg-background-600 hover:bg-background-600/80 px-15 py-4";
      styles.text = "text-white font-bold font-size-[18px]";
      break;
  }
